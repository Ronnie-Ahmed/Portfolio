  ...
  return (
    <div className="relative rounded-lg shadow-lg p-6">
      ...
      <div className="relative">
        ...
        <h3 className="text-2xl font-bold mb-2 rounded-sm text-center bg-gray-400 text-black">
          {title}
        </h3>
        <p className="font-bold   bg-gray-400 rounded-sm  backdrop-blur-lg">
          {description}
        </p>
        ...
        <a
          ...
          className="inline-block bg-gradient-to-r mt-2 from-blue-500 via-gray-500 to-blue-600 bg-opacity-70 text-white px-4 py-2 rounded-md shadow-md hover:shadow-lg transition-all duration-300 transform-gpu hover:scale-105 hover:rotate-3 hover:translate-y-[-2px] backdrop-filter backdrop-blur-lg"
        >
          View on GitHub
        </a>
        {Live && (
